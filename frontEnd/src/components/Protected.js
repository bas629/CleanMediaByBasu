...
function Protected() {
  ...
  const { savePost, changeHandler, PrivateFriend, ProtectedFriend, AddFriend,Unfriend, getPublicPost, ProtectedtPost, protectedPost } = useContext(ContextApp);
    ...
    <div className="flex flex-col min-h-screen bg-gray-900">
      ...
      <div className="sticky top-0 bg-gray-900 border-b border-gray-700 shadow-sm z-40 p-4">
        <div className="flex justify-between items-center max-w-4xl mx-auto">
          <h1 className="text-2xl font-bold text-white">Private Page</h1>
          <button
